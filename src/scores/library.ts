...
import {
  CelloSongScore, DifficultyTier, scoreDurationMs, measureDurationMs, BackingTrack, RawNoteEvent,
  CelloString, midiToPitchName, KeyMode, PitchClass, KeyDemand, keyDemand, openStringTonic,
} from '@domain';
 ...
 * instead of a thinned melody. See `harmonicGuide` in `domain/arranger`.
 */
